...
class PMOD_STATICDEPTH_OUTPUT(NamedTuple):
    depth: Tensor
    
class PMOD_STATICDEPTH_WDEC_OUTPUT(NamedTuple):
    segmentation: Tensor
    depth: Tensor
    staticdepth: Tensor
    aux1: Tensor
...
class PMOD_CONTRASTSD_OUTPUT(NamedTuple):
    segmentation: Tensor
    depth: Tensor
    aux1: Tensor
    aux2: Tensor
...
class INMAP_CONTRASTSD_OUTPUT(NamedTuple):
    contrast: Tensor
...
ARG_AUGMENTATION = 'augmentation'
ARG_GAUSSIAN_NOISE = 'gaussian_noise'
# Train: Network
ARG_BATCH_SIZE = 'batch_size'
ARG_RESUME = 'resume'
ARG_AMP = 'amp'
SHARED_WEIGHTS = 'shared_weights'
MOLDVECTOR = 'mold_vector'
# Train: Optimizer
...
# Train: inmap filter
ARG_FILTER_RADIUS = 'filter_radius'
# Train: Loss
ARG_L1 = 'l1'
ARG_SEG_CE = 'seg_ce'
ARG_SEG_CE_AUX1 = 'seg_ce_aux1'
ARG_SEG_CE_AUX2 = 'seg_ce_aux2'
ARG_CONTRASTIVE = 'contrastive'
ARG_SILOG = 'silog'
ARG_VARIANCE_FOCUS = 'variance_focus'
# Train: Debug
...
# IOPAINT IMG
DATASET_IOPAINTIMG = 'iopaint'

# STATIC DEPTH
DATASET_STATICDEPTH = 'staticdepth'

# for the contrastive
CONFIG_TAG_DYNAMIC_LABEL = 'dynamic_label'
DYNAMIC = 'dynamic'
STATIC = 'static'
...
CONFIG_STATICDEPTH = 'staticdepth'
CONFIG_OPTIMIZER = 'optimizer'
CONFIG_SCHEDULER = 'scheduler'
CONFIG_MOLDVECTOR = 'moldvec'
